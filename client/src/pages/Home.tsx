...
function ProductVisual({ product, detail = false }: { product: Product; detail?: boolean }) {
  ...
  return <div className={`${detail ? "detail-visual" : "product-image-wrap"} product-${product.slug}`}>
    <div className="visual-fallback" role="img" aria-label={visualLabel} data-visual-source="Eryndex product signal diagram"><span className="fallback-status">EDX / {product.number} · SIGNAL READY</span><svg className="product-motion-overlay" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
      ...
      {product.slug === "vessyra" && <g className="product-symbol-visual visual-vessyra"><g className="security-grid"><path className="grid-lines" d="M 18 28 H 82 M 18 46 H 82 M 18 64 H 82 M 31 13 V 87 M 50 13 V 87 M 69 13 V 87" /><path className="grid-sweep" d="M 22 18 L 78 78" /></g><path className="shield-layer shield-outer" d="M 50 13 L 82 30 L 75 67 Q 50 88 25 67 L 18 30 Z" /><path className="shield-layer shield-middle" d="M 50 13 L 82 30 Q 82 72 50 88 Q 18 72 18 30 Z" /><path className="shield-layer shield-inner" d="M 50 13 C 68 13 82 26 82 45 C 82 66 67 82 50 88 C 33 82 18 66 18 45 C 18 26 32 13 50 13 Z" /><path className="gate-frame gate-one" d="M 28 30 H 72 M 28 30 V 70 M 72 30 V 70 M 28 70 H 72" /><path className="gate-frame gate-two" d="M 34 24 H 66 M 34 24 V 76 M 66 24 V 76 M 34 76 H 66" /><path className="shield-scan" d="M 22 52 H 78" /><path className="shield-scan scan-two" d="M 31 69 H 69" /></g>}
