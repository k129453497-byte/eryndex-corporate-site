...
export function Home() {
  ...
  return <>
    ...
    <section className="principle-section"><div className="container principle-grid"><SignalRail label="EDX / PRINCIPLE" /><div className="principle-copy"><Eyebrow index="02">{lang === "en" ? "Our point of view" : lang === "zh-CN" ? "我们的观点" : "我們的觀點"}</Eyebrow><h2>{lang === "en" ? "Technology should return attention to people." : lang === "zh-CN" ? "科技應該把注意力還給人。" : "科技應該把注意力還給人。"}</h2><p>{lang === "en" ? "We design systems that reduce noise without hiding the reasoning. The result is not more dashboards to maintain, but more room for teams to decide, create, and grow." : lang === "zh-CN" ? "我们设计能减少噪音、却不隐藏判断过程的系统。结果不是更多需要维护的仪表板，而是让团队拥有更多时间去决策、创造与成长。" : "我們設計能減少噪音、卻不隱藏判斷過程的系統。結果不是更多需要維護的儀表板，而是讓團隊擁有更多時間去決策、創造與成長。"}</p><Link href="/about" className="arrow-link">{lang === "en" ? "See how we think" : lang === "zh-CN" ? "了解我们的想法" : "了解我們的想法"}<ArrowRight size={16} /></Link></div><div className="principle-mark" aria-hidden="true"><div className="mark-core"><img className="principle-brand-mark" src="/manus-storage/eryndex-mark-dark_0e671042.png" alt="" /></div><span className="principle-signal-dot dot-green" /><span className="principle-signal-dot dot-violet" /><span className="mark-label">SIGNAL<br />BECOMES<br />CONTEXT</span></div></div></section>
